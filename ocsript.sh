...
if [[ $vps = "vps" ]]; then
	source="source="https://raw.githubusercontent.com/Clrkz/VPSAutoScrptz/master"
else
...
read -p "Password baru: " -e -i Nel003 DatabasePass
echo ""
...
echo "<pre>Setup by nel003</pre>" > /home/vps/public_html/index.html
...
sed -i 's/DROPBEAR_PORT=143/DROPBEAR_PORT=3128/g' /etc/default/dropbear
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/nel003/project.html/master/issue.net"
...
wget -O about "https://raw.githubusercontent.com/nel003/project.html/master/about.sh"
...
echo "Dropbear : 143, 445, 3128"  | tee -a log-install.txt
...
echo "Modified by nel003"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
