...
echo 'echo -e "Script mod by Nel003"' >> .bashrc
...
sed -i 's/DROPBEAR_PORT=445/DROPBEAR_PORT=3128/g' /etc/default/dropbear
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/nel003/project.html/master/squid.conf"
...
echo "Dropbear : 145, 3128"  | tee -a log-install.txt
